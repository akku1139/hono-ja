...
- 基本的にプルリクエストを送ってください
- Typo などの小さな点は issue でも大丈夫です
- コミットメッセージは日本語を使用しても大丈夫です
- 行數を変更しないでください
  - 翻訳は翻訳元と同じ行に収めてください
...
### インラインコードブロックの前後には半角スペースを追加してください
...
1. GitHub の "Update branch" 機能が使用できる場合: "Update branch" で更新します

コンフリクトが発生する場合

2. ファイルや章の追加だった場合: 新しいファイルをそのまま追加し、目次も翻訳せずに追加します
3. 大きな変更の場合: 変更で元の翻訳を上書きします
4. 小さな変更の場合: マージするときに翻訳して取り込みます
